    ...
    <div class="col-12">
      <div class="card">
        <div class="card-body border-bottom py-3">
          ...
          <h1 class="card-title text-center" style="margin-top:-10px; font-size: 20px;"><b>LAPORAN DATA PERSEDIAAN</b></h1>

          <?= $this->session->flashdata('psn'); ?>
          <form action="<?= base_url(); ?>BarangPersediaan/exportPersediaan" method="POST" style="margin-top:50px;">
